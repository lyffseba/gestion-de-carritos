    ...
    <div className="bg-[#f2f2f2] min-h-[80vh] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-sm max-w-md w-full p-8">
        ...
        <div className="space-y-3">
          ...
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#25D366] rounded-md bg-[#25D366] text-white hover:bg-[#20bd5a] transition-colors shadow-sm font-bold">
        ...
        <div className="space-y-4">
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-md bg-blue-600 text-white font-bold hover:bg-blue-700 transition-colors shadow-sm">
