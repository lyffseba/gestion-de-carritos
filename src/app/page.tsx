    ...
    <div className="font-sans text-slate-700 min-h-screen pb-20 bg-white">
      ...
      <div className="relative w-full border-b border-slate-200 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-10 md:py-16">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <h1 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight flex items-center gap-3">
                Panel de Flota
              </h1>
            ...
            <div className="flex gap-4">
              <Link href="/admin" className="bg-indigo-600 text-white hover:bg-indigo-700 transition-colors font-medium text-sm px-5 py-2.5 rounded-md flex items-center gap-2">
                Añadir Vehículo
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-16">
          ...
          <div className="bg-white shadow-sm border border-slate-200 p-6 rounded-xl hover:border-slate-300 transition-colors">
            ...
            <p className="text-xs text-slate-400">Operativas actualmente</p>
          </div>
          ...
          <div className="bg-white shadow-sm border border-slate-200 p-6 rounded-xl hover:border-slate-300 transition-colors">
            ...
            <p className="text-xs text-slate-400">Estimado en cajas</p>
          </div>
          ...
          <div className="bg-white shadow-sm border border-slate-200 p-6 rounded-xl hover:border-slate-300 transition-colors">
            ...
            <p className="text-xs text-slate-400">Sin incidencias graves</p>
          </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-slate-900 tracking-tight">Centros Comerciales</h2>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              <Link key={node.id} href={`/catalog/${node.id}`} className="block bg-white shadow-sm border border-slate-200 rounded-xl p-5 hover:border-slate-300 transition-all group">
                ...
                <div className="text-sm md:text-base text-slate-900 font-medium mb-1 truncate">{node.name}</div>
        ...
        <div>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-slate-900 tracking-tight">Vehículos Recientes</h2>
            <Link href="/catalog" className="text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">
              Ver todos &rarr;
            </Link>
          </div>
